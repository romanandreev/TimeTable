...
// Instance Variables
//
    public MyCellAttribute cellAtt;
    /**
...
//
    ...
    /**
     *  Constructs a default <code>MyTableModel</code>
    ...
    /**
     *  Constructs a <code>MyTableModel</code> with
    ...
    /**
     *  Constructs a <code>MyTableModel</code> with as many columns
    ...
    public MyTableModel(Vector columnNames, int rowCount) {
        ...
        System.out.println("!" + rowCount + " " + columnNames.size());
        cellAtt = new MyCellAttribute(rowCount, columnNames.size());
    }

    /**
     *  Constructs a <code>MyTableModel</code> with as many
    ...
    /**
     *  Constructs a <code>MyTableModel</code> and initializes the table
    ...
    public void setDataVector(Vector dataVector, Vector columnIdentifiers) {
        ...
        cellAtt = new MyCellAttribute(dataVector.size(),
...
//
    ...
    private void justifyRows(int from, int to) {
        // Sometimes the MyTableModel is subclassed
